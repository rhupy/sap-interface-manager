  ...
  return (
    <AboutContainer>
      ...
      <Section>
        ...
        <List>
          <ListItem>SAP RFC 함수 호출 및 테스트</ListItem>
          ...
          <ListItem>모든 인터페이스 세팅의 저장 / 백업 / 배포 가능</ListItem>
        </List>
      </Section>

      <Section>
        <SectionTitle>문의 및 지원</SectionTitle>
        <p>
          문의사항이나 버그 리포트는 아래 Git 저장소에 이슈를 등록하거나 메일로
          연락바랍니다.
          <br />
          사용 방법은 GitHub 에서 README 를 참고해주세요.
        </p>
        <p>
          <Link
